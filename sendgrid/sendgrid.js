...
const sendMessageSendGrid = [
    {
        to: 'para1235886@gmail.com',
        from: 'parathan.thiyagalingam@velaris.io',
        subject: 'Sending with SendGrid is Fun',
        text: 'and easy to do anywhere, even with Node.js',
        html: htmlBody,
    }, {
        to: 'stlparathan@yahoo.com',
        from: 'parathan.thiyagalingam@velaris.io',
        subject: 'Sending with SendGrid is Fun',
        text: 'and easy to do anywhere, even with Node.js',
        html: htmlBody,
    }, {
        to: 'IT19125176@my.sliit.lk',
        from: 'parathan.thiyagalingam@velaris.io',
        subject: 'Sending with SendGrid is Fun',
        text: 'and easy to do anywhere, even with Node.js',
        html: htmlBody,
    }, {
        to: 'parathan98@hotmail.com',
        from: 'parathan.thiyagalingam@velaris.io',
        subject: 'Sending with SendGrid is Fun',
        text: 'and easy to do anywhere, even with Node.js',
        html: htmlBody,
    }, {
        to: 'chathura.velaris@gmail.com',
        from: 'parathan.thiyagalingam@velaris.io',
        subject: 'Sending with SendGrid is Fun',
        text: 'and easy to do anywhere, even with Node.js',
        html: htmlBody,
...
sgMail
  .sendMultiple(sendMessageSendGrid)
  .then((data) => {
    console.log('Email sent in SendGrid:', data)
  })
  .catch((error) => {
    console.error(error)
  });
